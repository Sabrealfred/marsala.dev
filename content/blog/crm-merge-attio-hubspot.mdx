...
- **High merge success rate:** 118,000 records were merged with a 98.7% success rate, with the rest flagged for manual review.
- **High match confidence:** The match confidence was 92 at the 95th percentile.
- **Fast automation re-enablement:** 15 automation flows were re-enabled within two weeks.
- **Quick support ticket resolution:** Support tickets related to the merge were resolved in under 12 hours, with fewer than 10 tickets in total.
- **Improved reporting accuracy:** The variance between forecast and actuals dropped from 15% to 3%.
- **Low data lag:** The delta feed lag between HubSpot and Attio was an average of 6 minutes.
- **High user adoption:** 94% of sales representatives logged into Attio in the first week.
- **Faster automation runtime:** The average automation runtime was reduced from 32 seconds in HubSpot to 18 seconds.
- **Improved data quality:** The composite data quality score (completeness, accuracy, timeliness) improved from 71 to 93 in Metaplane.

...
export const blogEntries = [
  {
    ...
    description:
      "Practical walkthrough for standing up a modular stack with the warehouse at the center, explicit contracts and weekly releases.",
    ...
    featured: true,
    signal: "We needed to ship new modules every week, so I built a stack that behaves like LEGO, not concrete.",
    context:
    ...
    playbook: [
      "Mapped every funnel stage and paired it with an owning module plus a data contract.",
      "Versioned all schemas in Git with dbt tests and reversible Airbyte ELT jobs.",
      "Tagged UI components with shared tokens and published a multi-brand Storybook.",
      "Committed to weekly releases using feature flags and PostHog experiments.",
      "Wrote swap runbooks so replacing CRM, CMS or email is just another PR.",
    ],
    metrics: [
  ...
  },
  {
    ...
    description:
      "Step-by-step tutorial for building reusable email workflows with components, testing and automation.",
    keywords: ["resend", "react email", "workflow", "automation"],
    tags: ["Email", "Automation"],
    image: "/blog/resend-workflows.jpg",
    featured: true,
    signal: "My email programs are modular—swapping content blocks no longer breaks the pipeline.",
    context:
    ...
    playbook: [
      "Designed hero/metrics/CTA components and published them as a private npm package.",
      "Wrote visual + accessibility tests directly in Storybook.",
      "Composed workflows in n8n by mixing those components as blocks.",
      "Ran QA across real inboxes and stored snapshots for audits.",
      "Instrumented telemetry to compare component performance.",
    ],
    metrics: [
  ...
  },
  {
    ...
    description:
      "How I structured a monthly roadmap council with data, templates and crisp decisions.",
    keywords: ["product ops", "roadmap", "council", "process"],
    tags: ["Product", "Ops"],
    image: "/blog/product-ops.jpg",
    featured: false,
    signal: "The roadmap stopped living in a static PDF—it became a living process.",
    context:
    ...
    playbook: [
      "Collect proposals via a single template with owner + expected metric.",
      "Review metrics/risks in a short synchronous session.",
      "Vote using predefined criteria and log the decision in Notion.",
      "Send auto recaps via Resend and update Linear tickets immediately.",
      "Run bi-weekly check-ins with owners to keep initiatives on track.",
    ],
    metrics: [
  ...
  },
  {
    ...
    description:
      "Case study on deploying AI in support with a controlled sandbox, guardrails and monitoring.",
    keywords: ["ai support", "sandbox", "healthtech", "compliance"],
    tags: ["AI", "Support"],
    image: "/blog/ai-support.jpg",
    featured: false,
    signal: "Support begged for AI, compliance had nightmares—the sandbox became our common ground.",
    context:
    ...
    playbook: [
      "Classified ticket types that were safe for AI and routed them to the sandbox.",
      "Trained prompts with de-identified data and regulatory rules baked in.",
      "Built a panel where agents approve/edit suggestions before sending.",
      "Measured accuracy and satisfaction before expanding coverage.",
      "Logged every action for audits with tamper-proof timestamps.",
    ],
    metrics: [
      "Resolution time: -52%",
      "Deflection rate: 87%",
  ...
  },
  {
    ...
    description:
      "Playbook for experimentation squads: intake, prioritization, QA and retros that fit inside a sprint.",
    keywords: ["experimentation", "sprints", "growth", "process"],
    tags: ["Growth", "Product"],
    image: "/blog/experimentation.jpg",
    featured: false,
    signal: "Experiments stopped being random bets—they became part of our heartbeat.",
    context:
    ...
    playbook: [
      "Weekly intake using a template (hypothesis, metric, owner).",
      "Prioritize with ICE score plus real capacity.",
      "Cross-team QA before flipping any flag.",
      "Friday demo + retro capturing actionable learnings.",
      "Auto-archive experiments with documentation snapshots.",
    ],
    metrics: [

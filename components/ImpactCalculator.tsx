      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr,1fr]">
          ...
          <motion.div
            ...
            className="overflow-hidden rounded-4xl border-2 border-moss-300 bg-gradient-to-br from-white to-moss-50 p-8 shadow-2xl lg:p-12"
          >
          ...
          <div className="lg:sticky lg:top-8 lg:self-start">
            <motion.div
              ...
              className="overflow-hidden rounded-4xl border-2 border-moss-400 bg-gradient-to-br from-moss-50 to-white p-8 shadow-xl"
            >
              ...
              <div className="mt-8">
                <MagneticButton href="/contact" strength={0.5}>
                  <span className="flex w-full items-center justify-center gap-2 rounded-full bg-moss-gradient px-10 py-4 text-base font-semibold text-white shadow-glow transition-all duration-300">

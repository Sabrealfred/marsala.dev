...
export default function Error({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center bg-cream-50 px-6 text-center">
      <div className="rounded-sm border-2 border-moss-200 bg-white px-8 py-10 shadow-xl">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <button
            type="button"
            onClick={() => reset()}
            className="rounded-sm bg-moss-gradient px-6 py-3 text-sm font-semibold text-white shadow-glow transition hover:shadow-hover"
          >
            Try again
          </button>
          <a
            href="/"
            className="rounded-sm border-2 border-moss-400 px-6 py-3 text-sm font-semibold text-moss-700 transition hover:bg-moss-50"
          >
            Back home
          </a>
        </div>

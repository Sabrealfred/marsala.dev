...
export default function ResearchPage() {
  ...
  return (
    <main className="min-h-screen bg-cream-50 dark:bg-moss-950">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-cream-50 via-moss-50 to-sage-50 py-12 lg:py-20 dark:from-moss-950 dark:via-moss-900 dark:to-moss-950">
